    ...
    <div class="row">
      ...
      <div class="col-lg-6 col-md-12">
        <div class="dashboard-list-box with-icons margin-top-20">
          ...
          <ul>
            <li>
              <i class="list-box-icon sl sl-icon-layers"></i> Your listing
              <strong><a href="#">Hotel Govendor</a></strong> has been approved!
            ...
            <li>
              <i class="list-box-icon sl sl-icon-star"></i> Kathy Brown left a
              review
            ...
            <li>
              <i class="list-box-icon sl sl-icon-heart"></i> Someone bookmarked
              your <strong><a href="#">Burger House</a></strong> listing!
              <a href="#" class="close-list-item"
                ><i class="fa fa-close"></i
              ></a>
            </li>
            ...
            <li>
              <i class="list-box-icon sl sl-icon-star"></i> John Doe left a
              review
            ...
            <li>
              <i class="list-box-icon sl sl-icon-star"></i> Jack Perry left a
              review
